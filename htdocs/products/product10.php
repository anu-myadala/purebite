<?php
$pageTitle = "Natural Fragrance Mist — PureBite Beauty";
include "../includes/header.php";
$productName = "Natural Fragrance Mist";
...
<div class='product-page'>
  <img src='/images/perfume.jpg' alt='Natural Fragrance Mist'>
  <div class='details'>
    <h1>Natural Fragrance Mist</h1>
    <p>Subtle floral blend for everyday freshness.</p>
